...
proc inspectItem (itemToInspect : ^Item)
	...
	case itemToInspect -> getName () (length (itemToInspect -> getName ())) of
	    label "s" :
		customPut (" " + itemToInspect -> getName () + " in your backpack.", true)
		return
	    label :
		case itemToInspect -> getName () (1) of
		    label "a", "e", "i", "o", "u" :
			customPut (" an " + itemToInspect -> getName () + " in your backpack.", true)
			return
		    label :
			customPut (" a " + itemToInspect -> getName () + " in your backpack.", true)
			return
		end case
	end case
	return
